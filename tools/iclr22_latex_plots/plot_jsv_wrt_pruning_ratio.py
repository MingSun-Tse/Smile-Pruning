...
fig, ax = plt.subplots(figsize=(4, 2.2), nrows=1, ncols=1)
...
# set legend
ax.legend(frameon=False, fontsize=legend_fs) # loc='lower right'

# set x y label
ax.set_xlabel('Pruning ratio', fontsize=label_fs)
ax.set_ylabel('Mean JSV', fontsize=label_fs)
